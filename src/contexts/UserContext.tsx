...
const AppContext = createContext<{ state: UserState; dispatch: Dispatch<Action>,  } | undefined>(undefined);
...
const appReducer = (state: UserState, action: Action): UserState => {
	switch (action.type) {
...
export { useUserContext as useAppContext };
